...
const PeopleCard = (props) => {
  ...
  return (
        ...
        <h2 className='font-semibold text-[14px]'>{user_data?.firstname?.slice(0,10)}{user_data?.firstname?.length >10 &&"..."} {user_data?.lastname?.slice(0,2)}{user_data?.lastname?.length>2&&"..."}</h2>
