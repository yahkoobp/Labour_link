  ...
  return (
    <div className='bg-gray-100 h-[100vh]'>
        <div className='w-full h-[100px] bg-blue-900 flex flex-col items-center justify-center sticky top-0 left-0'>
          ...
          <Paper
      component="form"
      sx={{ p: '2px 1px', display: 'flex', alignItems: 'center', width:300 ,boxShadow:1 , height:40,borderRadius:2 , marginTop:0 ,backgroundColor:"white"}}
      >
      ...
      />
        ...
        <div className='w-full fixed bottom-0 left-0'>
          ...
          <Drawer anchor="left" open={drawerOpen} onClose={()=>setDrawerOpen(false)} sx={{borderRadius:"10px"}}>
            <div className='flex flex-col items-center justify-start gap-2 px-4 py-6 h-full relative overflow-hidden'>
              ...
              <div className='flex flex-col w-full items-start justify-center mt-3'>
                ...
                <div className='flex gap-3 items-center justify-start cursor-pointer p-2 hover:bg-gray-100 w-full'>
                  <WorkOutlineOutlinedIcon sx={{color:"gray",width:17,height:17}}/>
              ...
              <div className='flex gap-3 items-center justify-start cursor-pointer p-2 hover:bg-gray-100 w-full absolute bottom-1 left-2'
              onClick={handleLogOut}>
                  <LogoutOutlinedIcon sx={{color:"black",width:20,height:20}}/>
